...
const useInterpolateStalk = (
  ...
  return useMemo(() => {
    ...
    skip,
    siloRewardsQuery.data?.snapshots,
    whitelistQuery.data?.snapshots,
    season,
    balances,
    sdk,
  ]);
