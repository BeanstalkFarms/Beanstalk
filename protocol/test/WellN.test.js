...
describe('Well', function () {
  before(async function () {
    ...
    await this.weth.mint(user2.address, to6('1000'))
  ...
  describe('Build Well', async function () {
    ...
    it('sets the well state', async function () {
      ...
      expect(cumulativeBalances[2]).to.be.equal(to6('0'))

      expect(await this.beanstalk.getLastTimestamp(wellId)).to.be.equal(await getTimestamp())

      expect(await this.beanstalk.getK(wellId)).to.be.equal(to6('300'))
    })
    ...
    it('returns the whole well', async function () {
      ...
      for (let i = 0; i < 2; i++) {
        ...
        expect(wholeWell.lpSupply).to.be.equal(to6('300'))
      }
    })
  ...
  describe("Add liquidity", async function () {
    ...
    describe("Basic", async function () {
      ...
      it("updates state", async function () {
        ...
        expect(await this.beanstalk.getK(wellId)).to.be.equal(to6('475.823133'))
      })
  ...
  describe("Remove liquidity", async function () {
    ...
    describe("Basic", async function () {
      ...
      it("transfers assets", async function () {
        ...
        expect(await this.weth.balanceOf(user2.address)).to.be.equal(to6('905'))
      })
      ...
      it("updates state", async function () {
        ...
        expect(await this.beanstalk.getK(wellId)).to.be.equal(to6('285'))
      })
  ...
  describe("Remove liquidity one token", async function () {
    ...
    describe("Basic", async function () {
      ...
      it("transfers assets", async function () {
        expect(await this.bean.balanceOf(user2.address)).to.be.equal(to6('909.670373'))
      ...
      it("updates state", async function () {
        ...
        expect(await this.beanstalk.getK(wellId)).to.be.equal(to6('289.999998'))
      })
  ...
  describe("Remove liquidity imbalanced", async function () {
    ...
    describe("Basic", async function () {
      ...
      it("updates state", async function () {
        ...
        expect(await this.beanstalk.getK(wellId)).to.be.equal(to6('285.996513'))
      })
