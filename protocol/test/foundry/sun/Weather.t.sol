...
contract ComplexWeatherTest is Weather, TestHelper {
    ...
    function testComplexWeatherCases() public {
        ...
        data = [
            ...
            WeatherData(251, 1000, 1, 0, 1, -1, 1, 0, 4_294_967_295, false, 1, 1, 4, 25, false),
            // WeatherData(0,1,0,0,0,1,100,0,4294967295,true,1,1,99,4,true),
            WeatherData(0, 1, 0, 0, 0, 100, 1, 0, 4_294_967_295, false, 26, 1, 1, 4, true),
            WeatherData(151, 1, 0, 0, 0, -1, 1, 0, 4_294_967_295, false, 26, 1, 4, 24, false)
        ...
        for (uint256 i = 0; i < data.length; ++i) {
            ...
            season.stepWeatherWithParams(
                pods, lastDSoil, uint128(startSoil - endSoil), endSoil, deltaB, raining, rainRoots
            );
...
contract ExtremeWeatherTest is Weather, TestHelper {
    ...
    function _beforeExtremeWeatherTest() public {
        season.setLastDSoilE(100_000);
        C.bean().mint(publius, 1_000_000_000);
        field.incrementTotalPodsE(100_000_000_000);
    }
