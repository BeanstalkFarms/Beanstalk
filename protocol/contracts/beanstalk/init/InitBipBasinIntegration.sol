...
contract InitBipBasinIntegration {
    ...
    uint32 private constant NEW_BEAN_GROWN_STALK_PER_BDV_PER_SEASON = 3e6;
    uint32 private constant NEW_BEAN_3CRV_GROWN_STALK_PER_BDV_PER_SEASON = 3.25e6;
    uint32 private constant BEAN_ETH_SEEDS_PER_BDV = 4.5e6;
    ...
    function init() external {
        ...
        LibWhitelist.updateStalkPerBdvPerSeasonForToken(
            C.BEAN,
            NEW_BEAN_GROWN_STALK_PER_BDV_PER_SEASON
        );
        LibWhitelist.updateStalkPerBdvPerSeasonForToken(
