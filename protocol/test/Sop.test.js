...
describe("Sop", function () {
  ...
  describe("1 sop", async function () {
    ...
    it("sops p > 1", async function () {
      ...
      expect(await this.weth.balanceOf(this.silo.address)).to.be.equal(
    ...
    it("tracks user plenty before update", async function () {
      expect(await this.siloGetters.connect(user).balanceOfPlenty(userAddress)).to.be.equal(
    ...
    it("tracks user2 plenty", async function () {
      expect(await this.siloGetters.connect(user).balanceOfPlenty(user2Address)).to.be.equal(
