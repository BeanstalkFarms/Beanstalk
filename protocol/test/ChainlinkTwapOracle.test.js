...
describe("TWAP Chainlink Oracle", function () {
  ...
  it("returns 0 if no rounds", async function () {
    expect(await mockBeanstalk.getChainlinkTwapEthUsdPrice("3600")).to.be.equal("0");
  });
  ...
  it("reports result if last round is older than lookback", async function () {
    ...
    expect(await mockBeanstalk.getChainlinkTwapEthUsdPrice("3600")).to.be.equal("10000");
  });
  ...
  it("reports average of 2 rounds", async function () {
    ...
    expect(await mockBeanstalk.getChainlinkTwapEthUsdPrice("3600")).to.be.equal("12500");
  });
  ...
  it("reports average of 3 rounds", async function () {
    ...
    expect(await mockBeanstalk.getChainlinkTwapEthUsdPrice("3600")).to.be.equal("15000");
  });
  ...
  it("reports average of 4 rounds with an old round", async function () {
    ...
    expect(await mockBeanstalk.getChainlinkTwapEthUsdPrice("3600")).to.be.equal("13750");
  });
});
