...
const nonBeanTokenMapping = {
  ...
  "0xbEA00EeEC3A0DC145c4dC5008f44212771a4704": "0xaf88d065e77c8cC2239327C5EDb3A432268e5831",
...
const tokensToWhitelist = [
  ...
  "0xbEA00EeEC3A0DC145c4dC5008f44212771a4704",
...
const tokenToGpAndOptimalPercentDepositedBdvMapping = {
  ...
  "0xbEA00EeEC3A0DC145c4dC5008f44212771a4704": ["120000000000000000000", "12000000"],
  ...
  try {
    ...
    for (const token of tokensToWhitelist) {
      ...
      if (token in assetSettings) {
        ...
        if (token === "0xbEA00EeEC3A0DC145c4dC5008f44212771a4704") {
