...
contract Order is Listing {
    ...
    */
    ...
    function _createDynamicPodOrder(
        ...
        require(beanAmount > 0, "Marketplace: Order amount must be > 0.");
        id = createDynamicOrderId(msg.sender, pricePerPod, maxPlaceInLine, f.breakpoints, f.constants, f.packedBases, f.packedSigns);
        ...
        emit DynamicPodOrderCreated(msg.sender, id, beanAmount, pricePerPod, maxPlaceInLine, polynomialBreakpoints, polynomialConstants, f.packedBases, f.packedSigns);
    }
    ...
    function _cancelDynamicPodOrder(
        ...
        bytes32 id = createDynamicOrderId(msg.sender, pricePerPod, maxPlaceInLine, f.breakpoints, f.constants, f.packedBases, f.packedSigns);
    ...
    */
    ...
    function createDynamicOrderId(
        ...
        uint256[2] calldata packedBases,
        uint256 packedSigns
    ) internal pure returns (bytes32 id) {
        id = keccak256(abi.encodePacked(account, pricePerPod, maxPlaceInLine, breakpoints, constants, packedBases, packedSigns));
    }
}
