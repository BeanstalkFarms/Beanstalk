...
library LibPRBMath60x18 {
    ...
    function exp2(uint256 xUint) pure internal returns (uint256 result) {
        // Numbers greater than or equal to 2^192 don't fit within the 192.64-bit format.
        if (xUint >= 192e18) revert("Exponent too big.");

        // Convert x to the 192.64-bit fixed-point format.
        uint256 x_192x64 = (xUint << 64) / SCALE;
    ...
    function prbExp2(uint256 x) pure private returns (uint256 result) {
