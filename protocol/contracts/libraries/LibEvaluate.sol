...
library LibEvaluate {
        ...
        )
    {
        ...
        uint256 dsoil = s.system.field.beanSown;
        s.system.field.beanSown = 0;
        (
            deltaPodDemand,
        ...
        // Calculate PodRate
        podRate = Decimal.ratio(s.system.field.pods.sub(s.system.field.harvestable), beanSupply); // Pod Rate
    }
