...
//  * @dev {Account.State} is the primary struct that is referenced from {AppStorage}.
...
//         mapping(address => System.AssetSilo) balances;
//         mapping(address => System.AssetSettings) settings;
...
//     * @param plentyPerRoots A mapping from Season to Plenty Per Root (PPR) in that Season. Plenty Per Root is 0 if a Season of Plenty did not occur.
//     * @param rain System.Rain
//      */
//     struct SeasonsOfPlenty {
//         address sopWell;
//         uint256 plenty;
//         mapping(uint32 => uint256) plentyPerRoots;
//         System.Rain rain;
//     }
// }
