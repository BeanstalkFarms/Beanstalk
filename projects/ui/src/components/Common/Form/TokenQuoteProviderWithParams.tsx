...
import useQuoteWithParams, { AdditionalQuoteHandlerParams, QuoteHandlerWithParams } from '~/hooks/ledger/useQuoteWithParams';
...
const TokenQuoteProviderWithParams : FC<TokenQuoteProviderProps> = ({
  /// Field
  name,
  state,
  balance,
  ...
  quoteSettings,
  // additional params needed for useQuote;
  params,
  /// Adornment
  ...
  const [result, quoting, getAmountOut] = useQuoteWithParams(tokenOut, handleQuote, quoteSettings, params);
...
export default TokenQuoteProviderWithParams;
