...
// useEffect(() => {
//   if (!convertResults || !targetStemTip?.gt(0)) {
...
//     convertResults,
//     targetStemTip: targetStemTip.toString(),
//   });

//   const toBDV = sdk.tokens.BEAN.fromBlockchain(convertResults.toBdv);
//   const baseStalkAfter = targetToken.getStalk(toBDV);

//   const deltaStem = targetStemTip.sub(convertResults.toStem);
//   const grownStalkAfter = STALK.fromBlockchain(
//     deltaStem.mul(convertResults.toBdv)
//   );
//   const grownStalkBefore = pickedDeposits.crates.reduce(
//     (prev, curr) => prev.add(curr.stalk.grown),
//     STALK.fromHuman('0')
//   );
//   const totalStalkAfter = baseStalkAfter.add(grownStalkAfter);
//   const deltaBaseStalk = baseStalkAfter.sub(pickedDeposits.stalk);
//   const deltaGrownStalk = grownStalkAfter.sub(grownStalkBefore);
//   /*
//     (stem tip of out - toStem) * toBDV
//   */

//   const deltaStalk = deltaBaseStalk.add(deltaGrownStalk);

//   const currOwnershipPct = farmerSilo.stalk.active.div(silo.stalk.active);

//   const afterSeeds = targetToken.getSeeds(toBDV);
//   const beforeSeeds = pickedDeposits.seeds;
//   const deltaSeed = afterSeeds.sub(beforeSeeds);

//   const afterOwnership = totalStalkAfter
//     .div(STALK.fromHuman(silo.stalk.active.toString()))
//     .toHuman();

//   const deltaOwnership = currOwnershipPct.minus(afterOwnership);

//   // setConvertDetails({
//   //   deltaSeed,
//   //   deltaStalk,
//   //   deltaOwnership: deltaOwnership,
//   //   deltaStalkPerSeason: TokenValue.ZERO,
//   // });
// }, [
//   sdk,
//   convertResults,
