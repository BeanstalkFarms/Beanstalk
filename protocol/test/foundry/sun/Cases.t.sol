...
contract CasesTest is TestHelper {
    ...
    function setUp() public {
        ...
        // call well to wsteth/bean to initalize mock pumps reserves to 0.
        // avoids errors due to gas limits.
        addLiquidityToWell(C.BEAN_WSTETH_WELL, 0, 0);
    }
    ...
    function testCases(uint256 caseId) public {
        ...
        int256 ratioChange = int256(bs.getBeanToMaxLpGpPerBdvRatio()) - int256(initialBeanToMaxLpGpPerBdvRatio);
        if(deltaB > 0) {
     ...
     */
    function testSowTimeSoldOutSlower(
        uint256 lastSowTime,
        uint256 thisSowTime
    ) public {
     ...
     */
    function testSowTimeSoldOutSowSameTime(
        uint256 lastSowTime,
        uint256 thisSowTime
    ) public {
        // set podrate to reasonably high,
     ...
     */
    function testSowTimeSoldOutFaster(
        uint256 lastSowTime,
        uint256 thisSowTime
    ) public {
        // set podrate to reasonably high,
