...
contract WhitelistTest is TestHelper {
    ...
    function test_whitelistRevertInvalidgpImplementation(
        uint i
    ...
    function test_whitelistRevertInvalidlwImplementation(
        uint i
    ) public prank(LibConstant.BEANSTALK) {
    ...
    function test_whitelistRevertInvalidOracleImplementation(
        uint i
    ) public prank(LibConstant.BEANSTALK) {
    ...
    function test_whitelistRevertZeroTargetOracleImplementation(
        uint i
    ) public prank(LibConstant.BEANSTALK) {
        address token = address(new MockWellToken());
        bytes4 gpSelector = IMockFBeanstalk.defaultGaugePointFunction.selector;
    ...
    function test_whitelistRevertExistingWhitelistedToken() public prank(LibConstant.BEANSTALK) {
        bytes4 gpSelector = IMockFBeanstalk.defaultGaugePointFunction.selector;
        bytes4 lwSelector = IMockFBeanstalk.maxWeight.selector;
