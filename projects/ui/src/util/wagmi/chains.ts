import { ChainId } from '@beanstalk/sdk';
import { defineChain } from 'viem';

export const MAINNET_RPC = `https://eth-mainnet.g.alchemy.com/v2/${import.meta.env.VITE_ALCHEMY_API_KEY}`;

export const ARBITRUM_RPC = `https://arb-mainnet.g.alchemy.com/v2/${import.meta.env.VITE_ALCHEMY_API_KEY}`;
