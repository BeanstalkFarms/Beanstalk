...
// TODO: curve is dewhitelisted - come back after liquidityWeight is merged.
...
//         const stemBean = await this.silo.mockSeasonToStem(this.bean.address, '12');
//         const stemMetapool = await this.silo.mockSeasonToStem(this.beanMetapool.address, '12');
...
//         beforeEach(async function () {
//           const stem = await this.silo.mockSeasonToStem(this.bean.address, '12');
...
//           //expect(await this.siloGetters.balanceOfSeeds(userAddress)).to.eq(toBean('600'));
...
//         it('properly updates user values', async function () {
//           //expect(await this.siloGetters.balanceOfSeeds(userAddress)).to.eq(toBean('800'));
//           expect(await this.siloGetters.balanceOfStalk(userAddress)).to.eq(toStalk('200'));
//         });
...
//           const stemBean = await this.silo.mockSeasonToStem(this.bean.address, '12');
//           expect((await this.siloGetters.getDeposit(userAddress, this.bean.address, stemBean))[0]).to.eq(toBean('0'));
//           const stemMetapool = await this.silo.mockSeasonToStem(this.beanMetapool.address, '13');
//           const deposit = await this.siloGetters.getDeposit(userAddress, this.beanMetapool.address, stemMetapool);
//           expect(deposit[0]).to.eq('200832430692705624354');
//           expect(deposit[1]).to.eq(toBean('200'));
//         });
...
//       describe('it converts', async function () {
//         beforeEach(async function () {
//           const stemBean10 = await this.silo.mockSeasonToStem(this.bean.address, '10');
//           const stemBean14 = await this.silo.mockSeasonToStem(this.bean.address, '14');
...
//         const stemMetapool = await this.silo.mockSeasonToStem(this.beanMetapool.address, '10');
...
//           expect(await this.siloGetters.totalStalk()).to.eq('10006181670000');
//         });

//         it('properly updates user values', async function () {
//           //expect(await this.siloGetters.balanceOfSeeds(userAddress)).to.eq('3801236334');
//           expect(await this.siloGetters.balanceOfStalk(userAddress)).to.eq('10006181670000');
//         });

//         it('properly updates user deposits', async function () {
//           const stemMetapool = await this.silo.mockSeasonToStem(this.beanMetapool.address, '10');
//           const stemBean = await this.silo.mockSeasonToStem(this.beanMetapool.address, '10');
//           let deposit = await this.siloGetters.getDeposit(userAddress, this.bean.address, stemBean);
//           expect(deposit[0]).to.eq(toBean('100.618167'));
//           expect(deposit[1]).to.eq(toBean('100.618167'));
//           deposit = await this.siloGetters.getDeposit(userAddress, this.beanMetapool.address, stemMetapool);
...
//           expect(await this.siloGetters.totalStalk()).to.eq('10008324310000');
//         });

//         it('properly updates user values', async function () {
//           //expect(await this.siloGetters.balanceOfSeeds(userAddress)).to.eq('3603293346');
//           expect(await this.siloGetters.balanceOfStalk(userAddress)).to.eq('10008324310000');
//         });

//         it('properly updates user deposits', async function () {
//           const stemMetapool = await this.silo.mockSeasonToStem(this.beanMetapool.address, '10');
//           const stemBean = await this.silo.mockSeasonToStem(this.bean.address, '10');
//           let deposit = await this.siloGetters.getDeposit(userAddress, this.bean.address, stemBean);
...
//           expect(await this.siloGetters.totalStalk()).to.eq('10010083524501');
//         });

//         it('properly updates user values', async function () {
//           expect(await this.siloGetters.balanceOfStalk(userAddress)).to.eq('10010083524501');
//         });

//         it('properly updates user deposits', async function () {
//           const stemMetapool = await this.silo.mockSeasonToStem(this.beanMetapool.address, '10');
//           expect((await this.siloGetters.getDeposit(userAddress, this.bean.address, -1))[0]).to.eq('100618167');
//           const deposit = await this.siloGetters.getDeposit(userAddress, this.beanMetapool.address, stemMetapool);
//           expect(deposit[0]).to.eq(to18('900'));
//           expect(deposit[1]).to.eq(toBean('900'));
//         });
...
//       describe('it converts', async function () {
//         beforeEach(async function () {
//           const stemMetapool10 = await this.silo.mockSeasonToStem(this.beanMetapool.address, '10');
//           const stemMetapool11 = await this.silo.mockSeasonToStem(this.beanMetapool.address, '11');
...
//           expect(await this.siloGetters.getTotalDeposited(this.beanMetapool.address)).to.eq(to18('900'));
//           expect(await this.siloGetters.getTotalDepositedBdv(this.beanMetapool.address)).to.eq(to6('900'));
//           expect(await this.siloGetters.totalStalk()).to.eq('10008082288167'); //updated from 10007981670000 for season based system
//         });

//         it('properly updates user values', async function () {
//           expect(await this.siloGetters.balanceOfStalk(userAddress)).to.eq('10008082288167');
//         });

//         it('properly updates user deposits', async function () {
//           const stemMetapool10 = await this.silo.mockSeasonToStem(this.beanMetapool.address, '10');
//           const stemBean10 = await this.silo.mockSeasonToStem(this.beanMetapool.address, '10');
//           expect((await this.siloGetters.getDeposit(userAddress, this.bean.address, 1))[0]).to.eq('100618167');
//           const deposit = await this.siloGetters.getDeposit(userAddress, this.beanMetapool.address, stemMetapool10);
