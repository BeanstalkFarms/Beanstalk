...
describe('Convert', function () {
  ...
  describe('Withdraw For Convert', async function () {
    describe("Bean", async function () {
      beforeEach(async function () {
        await this.silo.connect(user).depositBeans('100', [false, false, true]);
        await this.season.siloSunrise(0);
        await this.silo.connect(user).depositBeans('100', [false, false, true]);
      })
      ...
      describe("Withdraw 1 Crate", async function () {
        ...
        it('Emits event', async function () {
          ...
          await expect(this.result).to.emit(this.convert, 'MockConvert').withArgs('100', '0');
        })
      ...
      describe("Withdraw 2 Crates exact", async function () {
        ...
        it('Emits event', async function () { 
          ...
          await expect(this.result).to.emit(this.convert, 'MockConvert').withArgs('150', '200');
        })
    ...
    describe("LP", async function () {
      beforeEach(async function () {
        await this.silo.connect(user).depositLP('100', [false, false, true]);
        await this.season.siloSunrise(0);
        await this.silo.connect(user).depositLP('100', [false, false, true]);
      })
      describe("Revert", async function () {
      ...
      describe("Withdraw 2 Crates exact", async function () {
        ...
        it('Emits event', async function () { 
          ...
          await expect(this.result).to.emit(this.convert, 'MockConvert').withArgs('150', '400');
        })
    ...
    describe("Token", async function () {
      ...
      describe("Withdraw 2 Crates exact", async function () {
        ...
        it('Emits event', async function () { 
          ...
          await expect(this.result).to.emit(this.convert, 'MockConvert').withArgs('150', '100');
        })
