    ...
    Fertilizer1155
{
    ...
    // I think we have to leave this in cuz proxy stuff
    string private _uri;
    ...
    function lastBalanceOf(address account, uint256 id)
        public
        view
    ...
    function lastBalanceOfBatch(address[] memory accounts, uint256[] memory ids)
        external
        view
