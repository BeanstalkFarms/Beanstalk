...
describe("TokenValues", function () {
  ...
  it("toHuman()", () => {
    const v = TokenValue.fromBlockchain("123450000", 6);
    expect(v.toHuman()).toEqual("123.45");

    const numbers = [
      ["1000000000000000000", "1000Q"],
      ["100000000000000000", "100Q"],
      ...
      ["0.00000000001", "<.00000001"],
      ["0.000000000001", "<.00000001"],
      ["0.0000000000001", "<.00000001"],
      ["0.00000000000001", "<.00000001"],
      ["0.000000000000001", "<.00000001"],
      ["0.0000000000000001", "<.00000001"],
      ["0.00000000000000001", "<.00000001"],
      ["0.000000000000000001", "<.00000001"]
    ];

    for (const [value, formatted] of numbers) {
      expect(TokenValue.fromHuman(value, 18).toHuman("short")).toEqual(formatted);
    }

    const bigNumbers = [
      ["123456789012345678", 18, "0.1234"],
      ["123456789012345678", 17, "1.234"],
      ["123456789012345678", 16, "12.34"],
      ["123456789012345678", 15, "123.45"],
      ["123456789012345678", 14, "1,235"],
      ["123456789012345678", 13, "12,346"],
      ["123456789012345678", 12, "123,457"],
      ["123456789012345678", 11, "1.23M"],
      ["123456789012345678", 10, "12.34M"],
      ["123456789012345678", 9, "123.45M"],
      ["123456789012345678", 8, "1.234B"],
      ["123456789012345678", 7, "12.345B"],
      ["123456789012345678", 6, "123.456B"],
      ["123456789012345678", 5, "1.2345T"],
      ["123456789012345678", 4, "12.3456T"],
      ["123456789012345678", 3, "123.456T"],
      ["123456789012345678", 2, "1.23Q"],
      ["123456789012345678", 1, "12.3Q"],
      ["123456789012345678", 0, "123Q"]
    ];
    for (const [value, decimals, res] of bigNumbers) {
      // @ts-ignore
  ...
  it("toHuman() throws with bad format", () => {
    ...
    expect(() => {
      v.toHuman("bad");
    }).toThrowError("Unsupported formatting option: bad");
  });
});
