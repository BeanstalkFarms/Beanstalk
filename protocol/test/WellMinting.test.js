...
describe('Well Minting', function () {
  ...
  describe("Delta B > 0", async function () {
    ...
    it("Captures a delta B > 0", async function () {
      expect(await mockBeanstalk.callStatic.captureWellE(this.well.address)).to.be.equal('133789634067')
    })
  ...
  describe("Delta B < 0", async function () {
    ...
    it("Captures a delta B < 0", async function () {
      expect(await mockBeanstalk.callStatic.captureWellE(this.well.address)).to.be.equal('-225006447371')
    })
