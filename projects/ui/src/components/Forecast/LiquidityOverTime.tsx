...
const StatProps = {
  title: 'Liquidity',
  titleTooltip: 'The total USD value of the tokens in liquidity pools on the Oracle Whitelist at the beginning of every Season.',
  gap: 0.25,
  color: 'primary',
  sx: { ml: 0 },
};
...
const LiquidityOverTime: FC<{} & CardProps> = ({ sx }) => {
  ...
  const liquidity = Object.values(beanPools).reduce(
