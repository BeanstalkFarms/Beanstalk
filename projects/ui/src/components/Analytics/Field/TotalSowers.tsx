...
const getValue = (season: SnapshotData<SeasonalTotalSowersQuery>) =>
  season.numberOfSowers;
...
const TotalSowers: FC<{ height?: SeasonPlotBaseProps['height'] }> = ({
  height,
}) => {
