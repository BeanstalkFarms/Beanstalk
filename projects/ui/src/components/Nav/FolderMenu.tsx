...
import { BeanstalkPalette, PAGE_BORDER_COLOR, borderRadius } from '~/components/App/muiTheme';
      ...
      >
        <Box
          sx={(_theme) => ({
            ...
            borderTopRightRadius: zeroTopRightRadius ? 0 : borderRadius * 2,
            borderTopLeftRadius: zeroTopLeftRadius ? 0 : borderRadius * 2,
