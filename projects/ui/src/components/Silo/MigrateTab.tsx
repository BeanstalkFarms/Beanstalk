  ...
  return (
    <Centered minHeight="400px">
      ...
      {step === 2 && (
        <Stack textAlign="center" spacing={2} maxWidth={400}>
          ...
          <Typography variant="body1">
            Migrating allows you to use the latest Silo features. You&apos;ll
            need to pay a one-time transaction fee to perform the migration.
          </Typography>
          <Button variant="contained" size="medium" onClick={nextStep}>
            Next &rarr;
          </Button>
      ...
      {step === 4 && (
        <Stack textAlign="center" spacing={2} maxWidth={480}>
          <Typography variant="h1">
            When you receive new Earned Beans, there&apos;s a short delay before
            you can claim them.
          </Typography>
          <Typography variant="body1">
            This only applies to the Beans you received during the last Sunrise,
            and helps prevent certain attacks on Beanstalk. See {bip36} for
            details.
          </Typography>
          <Button variant="contained" size="medium" onClick={nextStep}>
            Next &rarr;
      ...
      {step === 5 && (
        <Stack textAlign="center" spacing={2} maxWidth={500}>
          ...
          <Typography variant="body1">
            Seeds are dynamic and can be adjusted over time through governance
            or automated mechanisms to help maintain peg and incentivize
            liquidity.
          </Typography>
          <Button variant="contained" size="medium" onClick={nextStep}>
            Next &rarr;
      ...
      {step === 6 && (
        <Stack textAlign="center" spacing={2} maxWidth={500}>
          ...
          <Typography variant="body1">
            ...
            BEAN:3CRV to 0 to help Beanstalk incentivize peg maintenance through
            conversions.
          </Typography>
          <Alert
            variant="outlined"
            ...
            sx={{ textAlign: 'left' }}
          >
            <strong>For Unripe holders:</strong> you won&apos;t lose any Stalk.
            All the Stalk earned up until BIP-36 will remain attached to your
            Deposits.
          </Alert>
          <Button variant="contained" size="medium" onClick={nextStep}>
            Next &rarr;
      ...
      {step === 7 && (
        <Stack textAlign="center" spacing={2} maxWidth={500}>
          ...
          <Typography variant="body1">
            This means they&apos;ll show up as tokens in popular wallets like
            MetaMask, and can be used on platforms like OpenSea. After you
            migrate, you&apos;ll be able to see your Deposits in your wallet.
          </Typography>
          <Alert
            variant="outlined"
            severity="warning"
            ...
            sx={{ textAlign: 'left' }}
          >
            <strong>Heads up!</strong> Sending the Deposit to another address
            via your wallet means you&apos;ll send the Stalk and Seeds too, just
            like a Deposit transfer.
          </Alert>
          <Button variant="contained" size="medium" onClick={nextStep}>
            Next &rarr;
          </Button>
