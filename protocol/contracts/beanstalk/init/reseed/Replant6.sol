...
//     address private constant BEAN_ETH = 0x87898263B6C5BABe34b4ec53F22d98430b91e371;

//     uint256 private constant AMOUNT_TO_UNRIPE_BEAN_ETH = 119894802186829;
//     uint256 private constant AMOUNT_TO_UNRIPE_BEAN_3CRV = 992035;
//     uint256 private constant AMOUNT_TO_UNRIPE_BEAN_LUSD = 983108;

//     function init(Deposit[] calldata ds) external {
//         for (uint256 i; i < ds.length; ++i) {
//             Deposit calldata d = ds[i];
//             if (d.token == BEAN_ETH) emit LPRemove(d.account, d.seasons, d.amounts, d.amount);
//             else emit RemoveSeasons(d.account, d.token, d.seasons, d.amounts, d.amount);
