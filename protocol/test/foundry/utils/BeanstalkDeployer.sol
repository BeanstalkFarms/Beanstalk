...
contract BeanstalkDeployer is Utils {
    ...
    function setupDiamond(bool mock, bool verbose) internal returns (Diamond d) {
        ...
        deployedFacetAddresses[i] = address(deployCode("BDVFacet"));
        facetNames[i++] = "BDVFacet";
        deployedFacetAddresses[i] = address(deployCode("CurveFacet"));
        facetNames[i++] = "CurveFacet";
        deployedFacetAddresses[i] = address(deployCode("FarmFacet"));
        facetNames[i++] = "FarmFacet";
        deployedFacetAddresses[i] = address(deployCode("PauseFacet"));
        facetNames[i++] = "PauseFacet";
        deployedFacetAddresses[i] = address(deployCode("OwnershipFacet"));
        facetNames[i++] = "OwnershipFacet";
        deployedFacetAddresses[i] = address(deployCode("TokenFacet"));
        facetNames[i++] = "TokenFacet";
        deployedFacetAddresses[i] = address(deployCode("TokenSupportFacet"));
        facetNames[i++] = "TokenSupportFacet";
        deployedFacetAddresses[i] = address(deployCode("GaugePointFacet"));
        facetNames[i++] = "GaugePointFacet";
        deployedFacetAddresses[i] = address(deployCode("LiquidityWeightFacet"));
        facetNames[i++] = "LiquidityWeightFacet";
        deployedFacetAddresses[i] = address(deployCode("SiloGettersFacet"));
        facetNames[i++] = "SiloGettersFacet";
        deployedFacetAddresses[i] = address(deployCode("ConvertGettersFacet"));
        facetNames[i++] = "ConvertGettersFacet";
        deployedFacetAddresses[i] = address(deployCode("MetadataFacet"));
        facetNames[i++] = "MetadataFacet";
        deployedFacetAddresses[i] = address(new SeasonGettersFacet());
        facetNames[i++] = "SeasonGettersFacet";
        deployedFacetAddresses[i] = address(deployCode("DepotFacet"));
        facetNames[i++] = "DepotFacet";
        if (mock) {
            deployedFacetAddresses[i] = address(deployCode("MockAdminFacet"));
            facetNames[i++] = "MockAdminFacet";
            deployedFacetAddresses[i] = address(deployCode("MockFertilizerFacet"));
            facetNames[i++] = "MockFertilizerFacet";
            deployedFacetAddresses[i] = address(deployCode("MockFieldFacet"));
            facetNames[i++] = "MockFieldFacet";
            deployedFacetAddresses[i] = address(deployCode("MockFundraiserFacet"));
            facetNames[i++] = "MockFundraiserFacet";
            deployedFacetAddresses[i] = address(deployCode("MockMarketplaceFacet"));
            facetNames[i++] = "MockMarketplaceFacet";
            deployedFacetAddresses[i] = address(deployCode("MockWhitelistFacet"));
            facetNames[i++] = "MockWhitelistFacet";
            deployedFacetAddresses[i] = address(deployCode("MockSiloFacet"));
            ...
            deployedFacetAddresses[i] = address(deployCode("FertilizerFacet"));
            facetNames[i++] = "FertilizerFacet";
            deployedFacetAddresses[i] = address(deployCode("FieldFacet"));
            facetNames[i++] = "FieldFacet";
            deployedFacetAddresses[i] = address(deployCode("FundraiserFacet"));
            facetNames[i++] = "FundraiserFacet";
            deployedFacetAddresses[i] = address(deployCode("MarketplaceFacet"));
            facetNames[i++] = "MarketplaceFacet";
            deployedFacetAddresses[i] = address(deployCode("WhitelistFacet"));
            facetNames[i++] = "WhitelistFacet";
            deployedFacetAddresses[i] = address(deployCode("SiloFacet"));
