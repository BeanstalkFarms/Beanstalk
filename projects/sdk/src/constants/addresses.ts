...
export const addresses = {
  ...
  BEANWETH_WELL: Address.make({
    ...
    [ChainId.ARBITRUM_MAINNET]: "0xBEA00AA912aEc233303C9455f0fc2D438ac929f5"
  }),
  BEANWSTETH_WELL: Address.make({
    [ChainId.ETH_MAINNET]: "0xBeA0000113B0d182f4064C86B71c315389E4715D",
    [ChainId.ARBITRUM_MAINNET]: "0xbea00BB0102b5F3C351a08c47C730fD0E9fD9870"
  }),
  BEANWEETH_WELL: Address.make({
    [ChainId.ARBITRUM_MAINNET]: "0xBEA00Cc5152e597eAfBA470453932BdC5fC3C8A1"
  }),
  BEANWBTC_WELL: Address.make({
    [ChainId.ARBITRUM_MAINNET]: "0xBeA00DD4B4D7cA2b4B49dE3D2A51189D22c1f31e"
  }),
  BEANUSDC_WELL: Address.make({
    [ChainId.ARBITRUM_MAINNET]: "0xbEA00EeEC3A0DC145c4dC5008f44212771a4704d"
  }),
  BEANUSDT_WELL: Address.make({
    [ChainId.ARBITRUM_MAINNET]: "0xBea00fF64E706B16bB5485B0aDe41d09DC95A9A9"
  }),
