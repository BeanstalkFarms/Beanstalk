...
//   const raised = await usdc.balanceOf(BCM)
//   percent = ethers.utils.parseEther('1')
//   // percent = raised.mul(ethers.utils.parseUnits('1', 12)).div(ethers.BigNumber.from('77000000'))
//   // console.log(percent)
...
//   // }
//   bdv = toBN(bdv).mul(toBN(percent)).div(ethers.utils.parseEther('1'))
//   // if (account_ == "0x01C7145c01d06a026D3dDA4700b727fE62677628") {
//   //   console.log(`${bdv}`)
//   // }
//   return [
