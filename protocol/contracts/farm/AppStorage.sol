...
contract Storage {
    ...
    struct Field {
        ...
        uint128 peas; // The maximum remaining potential pods that can be sown within a season.
    ...
    struct Weather {
        uint256 beanSown; // The maximum pods willing to be issued in a given season. 
