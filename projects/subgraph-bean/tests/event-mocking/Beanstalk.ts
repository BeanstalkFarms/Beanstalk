...
export function createMetapoolOracleEvent(season: BigInt, deltaB: BigInt, balances: BigInt[]): MetapoolOracle {
...
export function createWellOracleEvent(season: BigInt, well: string, deltaB: BigInt, cumulativeReserves: Bytes): WellOracle {
