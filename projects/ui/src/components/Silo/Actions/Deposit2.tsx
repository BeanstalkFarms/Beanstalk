...
// // import { Beanstalk } from '@beanstalk/sdk/src/constants/generated';
...
// import { QuoteHandler, QuoteHandlerNew } from '~/hooks/ledger/useQuote';
...
// import useSdk, { BeanstalkSdk, isSameToken, useToTokenMap } from '~/hooks/sdk';
// // import { ERC20Token, NativeToken } from '~/classes/Token';
// import { deposit as depositSilo } from '~/lib/Beanstalk/Silo/Deposit';
// import TransactionToast from '~/components/Common/TxnToast';
// import { parseError } from '~/util';
// import useGetChainToken from '~/hooks/chain/useGetChainToken';
// import { STALK, SEEDS } from '~/constants/tokens';
// import TokenSelectDialogNew from '~/components/Common/Form/TokenSelectDialogNew';
// import TokenQuoteProviderNew from '~/components/Common/Form/TokenQuoteProviderNew';

// const { BEAN, ETH, WETH, CRV3, DAI, USDC, USDT } = BeanstalkSdk.tokens;
...
//   const { amount, bdv, stalk, seeds, actions } = depositSilo(
//     whitelistedToken,
//     values.tokens,
//     amountToBdv,
//   );
...
//   // Whitelist
//   const whitelist = useToTokenMap(sdk.tokens.siloWhitelist);
//   const whitelistedToken = whitelist[_whitelistedToken.address];
...
//   ///
//   const initTokenList: Token[] = useMemo(() => {
//     const tkn = sdk.tokens;
//     const base = [tkn.BEAN, tkn.ETH] as Token[];
//     if (isSameToken(whitelistedToken, tkn.BEAN)) return base;
//     return [...base, whitelistedToken, tkn.CRV3, tkn.DAI, tkn.USDC, tkn.USDT];
...
//         ? combineBalances(balances[WETH.address], balances[ETH.address])
...
//         if (tokenIn === WETH) {
//           // estimate cost of buying BEAN with WETH / ETH
...
//           const tokenIndex = pool.tokens.findIndex((t) => t.address === tokenIn.address);
//           // const underlyingTokenIndex = pool.underlying.indexOf(tokenIn);
//           const underlyingTokenIndex = pool.underlying.findIndex((t) => t.address === tokenIn.address);
...
//       };
//     },
//     [balances, getChainToken, farm, pool]
//   );
...
//     }
//   }, [middleware, whitelistedToken, amountToBdv, sdk.contracts.beanstalk, refetchFarmerSilo, refetchFarmerBalances, refetchPools, refetchSilo]);
...
//             tokenList={tokenList as unknown as (ERC20Token | NativeToken)[]}
