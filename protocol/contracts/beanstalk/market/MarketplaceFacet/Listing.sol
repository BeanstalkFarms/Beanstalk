...
>>>>>>> Stashed changes
    function __fillListing(
        ...
        if (l.amount > amount) {
            s.podListings[l.index + amount  + l.start] = hashListing(
                0,
                l.amount - amount,
                l.pricePerPod,
                l.maxHarvestableIndex,
...
=======
    function __fillListingV2(
        ...
        if (l.amount > amount) {
            s.podListings[l.index + amount + l.start] = hashListingV2(
                0,
                l.amount - amount,
                l.pricePerPod,
                l.maxHarvestableIndex,
...
>>>>>>> Stashed changes
    ...
    function getAmountPodsFromFillListing(
        ...
        uint256 remainingAmount = podListingAmount - amount;
...
=======
    ...
    function hashListingV2(
        ...
        require(
            pricingFunction.length == LibPolynomial.getNumPieces(pricingFunction) * 168 + 32,
