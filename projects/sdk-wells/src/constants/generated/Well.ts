...
export interface WellInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "firstPumpBytes",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "firstPumpTarget",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "numberOfPumps",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "wellFunctionAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "wellFunctionBytes",
    values?: undefined
  ): string;
...
export type RemoveLiquidityOneTokenEvent = TypedEvent<
  [BigNumber, string, BigNumber],
  RemoveLiquidityOneTokenEventObject
>;

export type RemoveLiquidityOneTokenEventFilter =
  TypedEventFilter<RemoveLiquidityOneTokenEvent>;
...
export interface Well extends BaseContract {
  ...
  functions: {
    ...
    addLiquidity(
      ...
      minLpAmountOut: PromiseOrValue<BigNumberish>,
    ...
    firstPumpBytes(
      overrides?: CallOverrides
    ): Promise<[string] & { _bytes: string }>;

    firstPumpTarget(
      overrides?: CallOverrides
    ): Promise<[string] & { _target: string }>;

    getAddLiquidityOut(
      tokenAmountsIn: PromiseOrValue<BigNumberish>[],
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { lpAmountOut: BigNumber }>;

    getRemoveLiquidityImbalancedIn(
      tokenAmountsOut: PromiseOrValue<BigNumberish>[],
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { lpAmountIn: BigNumber }>;

    getRemoveLiquidityOneTokenOut(
      lpAmountIn: PromiseOrValue<BigNumberish>,
    ...
    getRemoveLiquidityOut(
      lpAmountIn: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BigNumber[]] & { tokenAmountsOut: BigNumber[] }>;
    ...
    numberOfPumps(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _numberOfPumps: BigNumber }>;

    numberOfTokens(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { __numberOfTokens: BigNumber }>;
    ...
    removeLiquidity(
      lpAmountIn: PromiseOrValue<BigNumberish>,
      minTokenAmountsOut: PromiseOrValue<BigNumberish>[],
      recipient: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    removeLiquidityImbalanced(
      maxLpAmountIn: PromiseOrValue<BigNumberish>,
      tokenAmountsOut: PromiseOrValue<BigNumberish>[],
      recipient: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    removeLiquidityOneToken(
      lpAmountIn: PromiseOrValue<BigNumberish>,
      tokenOut: PromiseOrValue<string>,
      minTokenAmountOut: PromiseOrValue<BigNumberish>,
      recipient: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    tokens(overrides?: CallOverrides): Promise<[string[]] & { ts: string[] }>;
    ...
    well(
      ...
      [string[], CallStructOutput, CallStructOutput[], string] & {
        _tokens: string[];
    ...
    wellFunctionAddress(
      overrides?: CallOverrides
    ): Promise<[string] & { __address: string }>;
  ...
  filters: {
    ...
    "RemoveLiquidityOneToken(uint256,address,uint256)"(
      ...
      tokenOut?: null,
      tokenAmountOut?: null
    ): RemoveLiquidityOneTokenEventFilter;
    RemoveLiquidityOneToken(
      lpAmountIn?: null,
      tokenOut?: null,
      tokenAmountOut?: null
