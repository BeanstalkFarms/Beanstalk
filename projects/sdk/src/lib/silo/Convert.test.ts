...
//   urBEAN.rewards = {
//     seeds: sdk.tokens.SEEDS.amount(0),
//     stalk: sdk.tokens.STALK.amount(0.000001)
//   }
...
//   }
  ...
  // it.skip("Validates tokens", async () => {
  //   const a = async () => {
  ...
  // it.skip("Validates amount", async () => {
  ...
  //   console.log("c3stalk: ", c1.stalk.total.toHuman());
  //   console.log("c2stalk: ", c2.stalk.total.toHuman());
  //   console.log("c3stalk: ", c3.stalk.total.toHuman());
