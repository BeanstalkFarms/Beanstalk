...
// TODO: How to configure, look into sgEnv
const wellsLink = new HttpLink({
  uri: 'http://127.0.0.1:8000/subgraphs/name/beanstalk-wells',
});
...
export const apolloClient = new ApolloClient({
  link: ApolloLink.split(
    (operation) => operation.getContext().subgraph === 'beanstalk-wells',
    wellsLink, // true
    ApolloLink.split(
