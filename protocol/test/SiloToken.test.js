...
describe('Silo Token', function () {
  ...
  describe('Withdraw Unripe LP', async function () {
    describe("Just legacy LP Deposit", async function () {
      beforeEach(async function () {
        await this.silo.connect(user).mockUnripeLPDeposit('0', '2', to18('15'), to6('10'))
      })
    ...
    describe("Just 3CRV LP Deposit", async function () {
      beforeEach(async function () {
        await this.silo.connect(user).mockUnripeLPDeposit('1', '2', to18('15'), to6('10'))
      })
    ...
    describe("Just BEAN:LUSD LP Deposit", async function () {
      beforeEach(async function () {
        await this.silo.connect(user).mockUnripeLPDeposit('2', '2', to18('15'), to6('10'))
      })
    ...
    describe("All 4 LP Deposit", async function () {
      beforeEach(async function () {
        await this.silo.connect(user).mockUnripeLPDeposit('0', '2', to18('10'), to6('2.5'))
        await this.silo.connect(user).mockUnripeLPDeposit('1', '2', to18('10'), to6('2.5'))
        await this.silo.connect(user).mockUnripeLPDeposit('2', '2', to18('10'), to6('2.5'))
